...
namespace mvcCrud2.Migrations
{
    ...
    [Migration("20220912035116_addShoppingCartToDb2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyBook.Models.Articulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.AplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BulkyBook.Models.ShoppingCart", b =>
                {
                    b.HasOne("BulkyBook.Models.AplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BulkyBook.Models.Articulo", "Product")
                        .WithMany()
